...
See the [API reference](https://naver.github.io/fixture-monkey/ko/docs/agent-guide/api-reference) for the full selector syntax and the object-creation entry points.
