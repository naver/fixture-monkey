...
/**
 * It defines what {@link TraverseNode} is for. Every node has a {@link TraverseNodeContext}.
 * Every node in a tree should have the same implementation of {@link TraverseNodeContext}.
 * For example, each node generates an object.
 */
...
public interface TraverseNodeContext {
	...
	/**
	 * retrieves the child node of {@link TraverseNodeContext}.
	 * It should not contain the mutable state during traversal.
	 *
