...
public final class BuilderArbitraryIntrospector
	...
	private static final Map<Class<?>, Method> BUILDER_CACHE = new ConcurrentHashMap<>(100);
	private static final Map<String, Method> BUILD_FIELD_METHOD_CACHE = new ConcurrentHashMap<>(100);
	private static final Map<Class<?>, Method> BUILD_METHOD_CACHE = new ConcurrentHashMap<>(100);
	private static final Map<Class<?>, Class<?>> BUILDER_TYPE_CACHE = new ConcurrentHashMap<>(100);

	private String defaultBuildMethodName = "build";
	private String defaultBuilderMethodName = "builder";
	private final Map<Class<?>, String> typedBuilderMethodName = new ConcurrentHashMap<>(100);
	private final Map<Class<?>, String> typedBuildMethodName = new ConcurrentHashMap<>(100);
