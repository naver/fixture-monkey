...
public interface JvmNodePromoter {
	...
	/**
	 * Promotes a JvmNodeCandidate to a List of JvmNodes using the provided context.
	 ...
	 * @return the list of promoted JvmNode instances
	 */
	List<JvmNode> promote(JvmNodeCandidate node, JvmNodeContext context);
}
