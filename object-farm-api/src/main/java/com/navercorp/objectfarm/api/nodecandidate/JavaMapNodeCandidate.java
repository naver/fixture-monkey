...
public final class JavaMapNodeCandidate implements JvmMapNodeCandidate {
	...
	/**
	 * Creates a new JavaMapNodeCandidate without a creation method.
	 * <p>
	 * This constructor is provided for backward compatibility.
	 *
	 * @param jvmType   the JVM type for this map candidate
	...
	public JavaMapNodeCandidate(JvmType jvmType, @Nullable String name, JvmNodeCandidate keyNode,
		...
		this(jvmType, name, keyNode, valueNode, null);
	}

	/**
	 * Creates a new JavaMapNodeCandidate with a creation method.
	 *
	 * @param jvmType        the JVM type for this map candidate
	 * @param name           the name of this candidate (may be null)
	 * @param keyNode        the key node candidate
	 ...
	 */
	public JavaMapNodeCandidate(JvmType jvmType, @Nullable String name, JvmNodeCandidate keyNode,
		JvmNodeCandidate valueNode, @Nullable CreationMethod creationMethod) {
