...
import com.navercorp.objectfarm.api.type.TypeReference;
...
class JavaNodeTest {
	...
	void listSelf() {
		// given
		JavaNode node = new JavaNode(
			new JavaType(new TypeReference<List<String>>() {
			}),
			"$",
			CONTEXT
		);
	...
	void nestedListSelf() {
		...
		JavaNode actual = new JavaNode(
			new JavaType(new TypeReference<List<List<String>>>() {
			}),
			"$",
			CONTEXT
		);
	...
	void arraySelf() {
		// given
		JavaNode node = new JavaNode(
			new JavaType(new TypeReference<String[]>() {
			}),
			"$",
			CONTEXT
		);
	...
	void listWithWildcardSelf() {
		// given
		JavaNode node = new JavaNode(
			new JavaType(new TypeReference<List<? extends String>>() {
			}),
			"$",
			CONTEXT
		);
	...
	void mapSelf() {
		// given
		JavaNode node = new JavaNode(
			new JavaType(new TypeReference<Map<String, Integer>>() {
			}),
			"$",
			CONTEXT
		);
	...
	void listMapSelf() {
		// given
		JavaNode node = new JavaNode(
			new JavaType(new TypeReference<List<Map<String, Integer>>>() {
			}),
			"$",
			CONTEXT
		);
	...
	void objectListSelf() {
		...
		JavaNode listNode = new JavaNode(
			new JavaType(new TypeReference<List<StringObject>>() {
			}),
			"$",
			CONTEXT
		);
	...
	void genericImplementation() {
		// given
		JavaNode node = new JavaNode(
			new JavaType(new TypeReference<GenericImplementation<String>>() {
			}),
			"$",
			CONTEXT
		);
	...
	void genericArrayTypeReference() {
		// given
		JavaNode node = new JavaNode(
			new JavaType(new TypeReference<GenericArrayObject<String>>() {
			}),
			"$",
			CONTEXT
		);
