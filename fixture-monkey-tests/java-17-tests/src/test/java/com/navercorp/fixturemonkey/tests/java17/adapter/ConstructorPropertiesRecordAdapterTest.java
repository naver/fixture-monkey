...
class ConstructorPropertiesRecordAdapterTest {
	...
	@RepeatedTest(TEST_COUNT)
	void fixedJavaType() {
		JavaTypeRecord actual = SUT.giveMeBuilder(JavaTypeRecord.class).fixed().sample();
	...
	@RepeatedTest(TEST_COUNT)
	void fixedDateTime() {
		DateTimeRecord actual = SUT.giveMeBuilder(DateTimeRecord.class).fixed().sample();
	...
	@RepeatedTest(TEST_COUNT)
	void fixedContainer() {
		ContainerRecord actual = SUT.giveMeBuilder(ContainerRecord.class).fixed().sample();
	...
	void fixedInterfaceContainer() {
		ComplexContainerRecord actual = SUT.giveMeBuilder(ComplexContainerRecord.class).fixed().sample();
	...
	void sampleTwoConstructorsRecord() {
		String actual = SUT.giveMeBuilder(TwoConstructorsRecord.class).setNotNull("string").sample().string();
	...
	void recordShouldUseCanonicalConstructor() {
		...
		String actual = SUT.giveMeBuilder(TwoConstructorsRecord.class).set("string", expected).sample().string();
	...
	void recordUseCompactConstructor() {
		...
		String actual = SUT.giveMeBuilder(CompactConstructorRecord.class).set("string", expected).sample().string();
	...
	void fixedTwoConstructorsRecord() {
		String actual = SUT.giveMeBuilder(TwoConstructorsRecord.class).setNotNull("string").fixed().sample().string();
	...
	void fixedNoArgsConstructorRecord() {
		NoArgsConstructorRecord actual = SUT.giveMeBuilder(NoArgsConstructorRecord.class).fixed().sample();
