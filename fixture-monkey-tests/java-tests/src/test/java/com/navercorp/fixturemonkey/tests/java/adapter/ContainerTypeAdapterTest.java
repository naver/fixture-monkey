...
class ContainerTypeAdapterTest {
	...
	@Disabled("ContainerObject contains Map.Entry fields not yet supported in Adapter")
	...
	@Disabled("Map.Entry root type with ConstructorPropertiesArbitraryIntrospector not yet supported in Adapter")
	@RepeatedTest(TEST_COUNT)
