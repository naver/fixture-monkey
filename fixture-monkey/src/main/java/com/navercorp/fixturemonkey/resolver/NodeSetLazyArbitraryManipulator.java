...
final class NodeSetLazyArbitraryManipulator<T> implements NodeManipulator {
	private final Supplier<T> arbitrarySupplier;

	NodeSetLazyArbitraryManipulator(Supplier<T> arbitrarySupplier) {
