...
final class WinningValueCandidate {
	...
	WinningValueCandidate(Object declaredPath, ValueCandidate candidate, int scopeDepth, JvmNode scopeNode) {
	...
	boolean isScopeRoot() {
		return declaredPath instanceof ScopedPath && ((ScopedPath)declaredPath).isScopeRoot();
	}
}
