...
Human readers looking for an introduction should start with [Creating objects](https://naver.github.io/fixture-monkey/docs/get-started/creating-objects) instead.
...
| Page | Contents |
| :--- | :--- |
| [Writing tests](https://naver.github.io/fixture-monkey/docs/agent-guide/writing-tests) | The decision procedure: how to tell which properties a scenario depends on, which API to pin them with, and how to verify the result |
| [API reference](https://naver.github.io/fixture-monkey/docs/agent-guide/api-reference) | Condensed Java and Kotlin API surface — selectors, builder methods, setup |
