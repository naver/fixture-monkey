...
FixtureMonkey fixtureMonkey = FixtureMonkey.builder()
    .register(CreditCard.class, fm -> fm
        ...
        .set("number", /* formatted 16-digit starting with VISA */)
        .set("expiryDate", /* 2 years from now */)
        .set("cvv", /* 3-digit between 100-999 */))
    .build();
...
```java
FixtureMonkey fixtureMonkey = FixtureMonkey.builder()
    .pushExactTypePropertyGenerator(PropertyAddress.class, (property, context) -> /* custom generator */)
    .build();
```
