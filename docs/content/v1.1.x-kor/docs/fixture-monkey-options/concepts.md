...
> * [타입 구성](../essential-options-for-beginners#type-configuration) (필수 옵션)
> * [커스텀 타입 등록 및 생성](../advanced-options-for-experts#custom-type-registration-and-generation) (고급 옵션)
...
> * [커스텀 객체 인트로스펙션](../essential-options-for-beginners#custom-object-introspection) (필수 옵션)
> * [객체 프로퍼티 생성기](../advanced-options-for-experts#object-property-generators) (고급 옵션)
> * [컨테이너 처리 옵션](../advanced-options-for-experts#container-handling-options) (고급 옵션)
...
> 복잡한 구성의 예시는 [실제 고급 구성](../advanced-options-for-experts#real-world-advanced-configuration) (고급 옵션)을 참조하세요.
