...
import ArbitraryTestJava from '@examples-java/customizing/ArbitraryTest.java';
import ArbitraryKotlinTest from '@examples-kotlin/customizing/ArbitraryKotlinTest.kt';
...
<CodeSnippet src={ArbitraryTestJava} language="java" method="basicRange" />

</TabItem>
<TabItem value="kotlin" label="Kotlin">

<CodeSnippet src={ArbitraryKotlinTest} language="kotlin" method="basicRange" />
...
<CodeSnippet src={ArbitraryTestJava} language="java" method="stringPatterns" />

</TabItem>
<TabItem value="kotlin" label="Kotlin">

<CodeSnippet src={ArbitraryKotlinTest} language="kotlin" method="stringPatterns" />
...
<CodeSnippet src={ArbitraryTestJava} language="java" method="selectFromOptions" />

</TabItem>
<TabItem value="kotlin" label="Kotlin">

<CodeSnippet src={ArbitraryKotlinTest} language="kotlin" method="selectFromOptions" />
...
<CodeSnippet src={ArbitraryTestJava} language="java" method="multipleConstraints" />

</TabItem>
<TabItem value="kotlin" label="Kotlin">

<CodeSnippet src={ArbitraryKotlinTest} language="kotlin" method="multipleConstraints" />
