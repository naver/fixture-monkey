...
See the [tracing guide](/docs/debugging/tracing) for details. (From v1.2.0 this engine is the default; the tracer is configured via `FixtureMonkeyBuilder.tracer(AssemblyTracer.console())`.)
