...
import BasicCreationTestJava from '@examples-java/getstarted/BasicCreationTest.java';
...
<CodeSnippet src={BasicCreationTestJava} language="java" />
...
<CodeSnippet src={BasicCreationTestJava} language="java" showClass />
