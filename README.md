...
```groovy
// Java
testImplementation("com.navercorp.fixturemonkey:fixture-monkey-starter:1.1.22")

// Kotlin
testImplementation("com.navercorp.fixturemonkey:fixture-monkey-starter-kotlin:1.1.22")
```
