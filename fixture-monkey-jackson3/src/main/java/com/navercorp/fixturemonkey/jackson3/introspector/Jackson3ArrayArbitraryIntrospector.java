...
public final class Jackson3ArrayArbitraryIntrospector implements ArbitraryIntrospector, Matcher {
	public static final Jackson3ArrayArbitraryIntrospector INSTANCE = new Jackson3ArrayArbitraryIntrospector(
		FixtureMonkeyJackson3.defaultJsonMapper()
	);

	private final ObjectMapper objectMapper;

	public Jackson3ArrayArbitraryIntrospector(ObjectMapper objectMapper) {
	...
	public ArbitraryIntrospectorResult introspect(ArbitraryGeneratorContext context) {
		...
		JavaType elementType = typeFactory.constructType(new Jackson3TypeReference<Object>() {
			@Override
			public Type getType() {
		...
		ArrayType arrayType = typeFactory
